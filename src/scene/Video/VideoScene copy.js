              ...
              }}>
              {
                this.state.isPlaying ? null :
                  <TouchableWithoutFeedback onPress={() => { this.onPressPlayButton() }}>
                      <Icon style={styles.playButton} name='angle-right' size={18} color="#ccc"></Icon>
          ...
          </TouchableWithoutFeedback>
          {
            this.state.showVideoControl ?
              <View style={[styles.control, {width: this.state.videoWidth}]}>
                ...
                <Icon style={styles.playControl} name={this.state.isPlaying ? 'angle-right':'angle-pause'} size={18} color="#ccc"></Icon>
                </TouchableOpacity>
                ...
                <Icon style={styles.shrinkControl} name={this.state.isFullScreen ? 'angle-right':'angle-pause'} size={18} color="#ccc"></Icon>
                </TouchableOpacity>
              </View> : null
          }
        </View>
